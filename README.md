...
| AI 서버    | LangChain 설계, 챗봇 프롬프트 엔지니어링, embedding, vector db| 전정빈 , 오상민          |
...
![API_엔드포인트](./API%20엔드포인트/스크린샷%202025-08-26%20234113.png)
![API_엔드포인트](./API%20엔드포인트/스크린샷%202025-08-26%20234145.png)
![API_엔드포인트](./API%20엔드포인트/스크린샷%202025-08-26%20234212.png)
