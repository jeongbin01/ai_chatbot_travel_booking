...
const onlyParis = (a) => {
  ...
  return (
    ...
    raw.includes("Île-de-France") || // 지역에만 표기된 경우
    /7500[1-9]|7501[0-9]|7502[0-9]|7503[0-9]|75116/.test(lower) || // 파리 우편번호대
    /\b(\d{1,2})(?:e|er)?\s*arr/.test(lower) // 1er/2e arr. 등
  );
};
...
export default function ParisAccommodations() {
  ...
  const [items, setItems] = useState([]); // 파리만
