// src/pages/accommodations/RomeAccommodations.jsx
...
const onlyRome = (a) => {
  ...
  const keywords = [
    ...
    "트레비", "trevi",
    "스페인광장", "spanish steps", "piazza di spagna",
...
const LOCAL_FALLBACKS = {
  [toSlug("로마 호텔")]: IMG_ROME_HOTEL,
};

// ✅ 썸네일 포커스(없으면 중앙)
const FOCUS_MAP = {
  [toSlug("로마 호텔")]: { x: "50%", y: "50%" },
};
