// src/pages/accommodations/BangkokAccommodations.jsx
...
// ✅ 로컬 폴백 이미지
import IMG_BKK_HOTEL from "../../../assets/images/overseas/방콕 호텔.jpg";
...
const onlyBangkok = (a) => {
  ...
  const keywords = ["방콕", "bangkok", "수쿰윗", "sukhumvit", "카오산", "khaosan", "차오프라야", "chao phraya", "사톤", "sathon", "실롬", "silom", "아속", "asok", "프롬퐁", "phrom phong"];
...
const LOCAL_FALLBACKS = {
  [toSlug("방콕 호텔")]: IMG_BKK_HOTEL,
};

// ✅ 썸네일 포커스(없으면 중앙)
const FOCUS_MAP = {
  [toSlug("방콕 호텔")]: { x: "50%", y: "50%" },
};
